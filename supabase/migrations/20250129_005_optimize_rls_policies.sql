...
CREATE POLICY "Users can view their own documents in view" ON public.user_documents_with_block_count
...
COMMENT ON VIEW public.user_documents_with_block_count IS 'Optimized view for document listings with block counts';