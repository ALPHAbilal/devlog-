...
#### **Image Support Enhancements** (NEW!)
- **Inline Images in Text Blocks**
  - Tiny thumbnail previews that expand on click
  - Smart image placeholders (📷[image-0]) instead of base64 strings
  - Paste images directly from clipboard
  - Full zoom and pan controls in expanded view
    - Scroll wheel zoom (50% to 300%)
    - Drag to pan when zoomed in
    - Zoom controls toolbar with reset button
  - Maintains document flow without disruption
  - Images stored as base64 for portability

#### **Code Block Enhancements** (NEW!)
- **File Path Autocomplete**
  - Smart suggestions based on existing code blocks
  - Extracts paths from FileTree blocks automatically
  - Prioritizes matches by relevance
  - Shows up to 10 most relevant suggestions
  - Searches across all documents in the system
- **Improved File Path Display**
  - Tab-style label above code blocks
  - Green accent color for visibility
  - Persists between edit/view modes
  - No overlap with version tracking badges
- **Better Edit Mode Behavior**
  - File path input doesn't trigger block exit
...
- **Removed visual clutter** - No more vertical green focus lines
- **Better positioning** - Version badges and file paths don't overlap
